...
contract DAudit is ReentrancyGuard {
    ...
    /// @notice Returns the fee charged to the producers including listing fee + fees paid to auditors
    /// @param _auditFee fee charged for listing an audit item
    function calculateProducerFee(uint256 _auditFee ) public view returns (uint256) {
        return listingFee + _auditFee ;
    }
